...
router.post('/', authenticateToken, upload.single('itemPhoto'), loanController.createLoan);
router.put('/:id', authenticateToken, upload.single('itemPhoto'), loanController.updateLoan);
